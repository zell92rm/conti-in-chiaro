...
const englishReplacements: Array<readonly [string, string]> = [
  ...
  ...[
    ...
    ["Sposta", "Move"], ["Sposta spesa fissa", "Move fixed expense"], ["Conto di destinazione", "Destination account"],
    ["Cambia conto associato", "Change associated account"],
    ["Spostamento in corso…", "Moving…"],
    ["Note, parole chiave, pagamenti e mesi saltati vengono conservati. I movimenti registrati restano sul conto originale.", "Notes, keywords, payments and skipped months are preserved. Recorded transactions stay in the original account."],
    ["Nessun altro conto disponibile. Crea un conto Personale o Spese mese per spostare questa spesa.", "No other account available. Create a Personal or Monthly expenses account to move this expense."],
    ["Operazione non riuscita. Controlla la connessione e riprova.", "Operation failed. Check your connection and try again."],
    ["Spesa fissa o conto non valido", "Invalid fixed expense or account"],
    ["Seleziona un conto Personale o Spese mese", "Select a Personal or Monthly expenses account"],
    ["Spesa fissa non trovata", "Fixed expense not found"],
